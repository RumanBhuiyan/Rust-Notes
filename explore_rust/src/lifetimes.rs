...
// by using &'static here we are telling rust that don't drop "Happy coding" when you get } at end
// rather wait for finishing entire program then drop off "Happy coding"
pub fn get_reference()-> &'static str{
    "Happy coding"
}
// after providing reference to d if a and b are destroyed/dropped then d will point to which reference???
